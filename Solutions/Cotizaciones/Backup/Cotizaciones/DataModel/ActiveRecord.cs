...
namespace Cotizaciones.DataModel
{
    ...
    /// <summary>
    /// A class which represents the Users table in the Fersum Database.
    /// </summary>
    public partial class User: IActiveRecord
    {
        ...
        string _NotifyToEmail;
        public string NotifyToEmail
        {
            get { return _NotifyToEmail; }
            set
            {
                if(_NotifyToEmail!=value){
                    _NotifyToEmail=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="NotifyToEmail");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }
    ...
    public partial class Quotation: IActiveRecord
    {
        ...
        public string PDFFileName
        {
            ...
            set
            {
                if(_PDFFileName!=value){
                    _PDFFileName=value;
                    var col=tbl.Columns.SingleOrDefault(x=>x.Name=="PDFFileName");
                    if(col!=null){
                        if(!_dirtyColumns.Any(x=>x.Name==col.Name) && _isLoaded){
                            _dirtyColumns.Add(col);
                        }

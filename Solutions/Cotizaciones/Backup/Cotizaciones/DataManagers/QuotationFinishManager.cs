...
namespace Cotizaciones.DataManagers
{
    ...
    {
        public static void SaveQuotationFinishDetails(int QuotationID, string User, string Notes, string ValidPeriodDescription, string PaymentDescription, string InvoiceMethodDescription)
        {
        ...
        public static void FinalizeQuotation(int QuotationID, string FileName, string User)
        {
            UpdateQuotationStatus(QuotationID, FileName, User, Cotizaciones.Enums.QuotationStatusType.Finished);
        }

        private static void UpdateQuotationStatus(int QuotationID, string FileName, string User, Cotizaciones.Enums.QuotationStatusType newStatus)
        {
